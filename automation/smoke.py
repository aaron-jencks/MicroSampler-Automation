...
def run_reporting_checks(ctx: Dict, actions: Dict[str, Any], reporter: ReportLog):
    ...
    ensure("## Transcript" in report_text, "final report missing transcript section")
    ensure("## Model Report" in report_text, "final report missing model report section")
    ensure("## Suggestion Report" in report_text, "final report missing suggestion section")
    ensure("## Simulation Report" in report_text, "final report missing simulation section")
